...
add_action( 'homepage_v11', 'electro_home_v11_page_template_content',                           5 );
...
add_action( 'homepage_v12', 'electro_home_v12_slider_block',                                    10 );
add_action( 'homepage_v12', 'electro_home_v12_body_inner_wrap_start',                           20 );
add_action( 'homepage_v12', 'electro_home_v12_page_template_content',                           30 );
add_action( 'homepage_v12', 'electro_home_v12_categories_block',                                40 );
add_action( 'homepage_v12', 'electro_home_v12_hot_products',                                    50 );
add_action( 'homepage_v12', 'electro_home_v12_banners',                                         60 );
add_action( 'homepage_v12', 'electro_home_v12_new_products',                                    70 );
add_action( 'homepage_v12', 'electro_home_v12_recommend_products',                              80 );
add_action( 'homepage_v12', 'electro_home_v12_blog_posts',                                      90 );
add_action( 'homepage_v12', 'electro_home_v12_brands_block',                                    100 );
add_action( 'homepage_v12', 'electro_home_v12_body_inner_wrap_end',                             110 );
...
add_action( 'electro_before_homepage_v12', 'electro_home_v12_hook_control',                   10 );
