...
<div id="page" class="hfeed site">
    <?php
    /**
     * Functions hooked into electro_before_header_v11 action
     *
     * @hooked electro_top_bar_v11    - 10
     */
    do_action( 'electro_before_header_v11' ); ?>
        ...
        <header id="masthead" class="site-header header-v11">
            <div class="stick-this">
                <div class="container <?php echo esc_attr( has_electro_mobile_header() ? electro_desktop_header_responsive_class() : '' );  ?>">
                    <?php
                    /**
                     * Functions hooked into electro_header_v11 action.
                     *
                     * @hooked electro_masthead_v11    - 10
                     */
                    do_action( 'electro_header_v11' );
                    ?>
